...
This package alows you to start an activity (Android) or show a modal window (iOS) for adding or editing events in deice's calendar. Through a promise, you can find out if a new event was added and get its id. See the usage section for more information.
